...
全连接神经网络
示范tensorboard的用法
* 使用name_scope归类结点，从而只显示scope级别的张量
* 使用scalar注册向量：tf.summary.scalar("loss", cost)
* 使用tf.summary.merge_all()收集事件
* 使用SummaryWriter发送事件


进阶主要使用distribution和histogram
即分布图和柱状图
