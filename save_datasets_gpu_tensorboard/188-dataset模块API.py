...
sess.run(iterator.initializer, feed_dict={input_x: mnist.train.images,
...
for step in range(1, num_steps + 1):
    ...
    try:
        ...
        sess.run(iterator.initializer, feed_dict={input_x: mnist.train.images, input_y: mnist.train.labels})
        sess.run(train_op)
